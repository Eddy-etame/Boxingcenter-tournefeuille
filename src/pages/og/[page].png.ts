 ...
 * ville, les deux clubs et les lignes qui y mènent.
 *
...
const aiguillage = () =>
  h(
    ...
    h(
      ...
      h('circle', { cx: 180, cy: 150, r: 13, fill: T.papier, stroke: T.encre, strokeWidth: 2 }),
    ...
    etiquette(SITE.ville.toUpperCase(), 0, 118, 'flex-start', T.encre),
    etiquette('TA DISCIPLINE', 40, 162, 'flex-start', T.graphite, 12),
