...
Le moteur garde le choix de club (comme Colomiers) et le graphe réel tranche : **boxe thaï / Muay Thaï → Saint-Cyprien** (Portet publie « kick-boxing », pas « Muay Thaï ») · **MMA / grappling / cage → Portet** (Saint-Cyprien n'affiche pas de MMA sur son accueil — vérifier /activites/) · boxe anglaise → les deux, le trajet départage (métro A depuis Toulouse-ouest vs voiture vers le sud). `/quel-club/` conservé.
...
Nav : Plannings ↗ et Tarifs ↗ ouvrent un **menu à deux entrées** (Portet / Saint-Cyprien) ou pointent sur `/quel-club/#plannings` qui liste les deux — à trancher ; jamais un seul club en dur.
